...
ui<-dashboardPage(
  ...
  dashboardBody(
    tags$img(
      src = "https://source.wustl.edu/wp-content/uploads/2020/03/shutterstock_COVID19-molecule-scaled.jpg",
    ...
    fluidRow(box(title=h3(p(strong("Total Deaths in US"))),hr(),h1(p(strong(total_death))),height=200,width=3,background="green")),
    fluidRow(box(title=h3(p(strong("Total Cases in last 7 days"))),hr(),h1(p(strong(avg_count))),height=200,width=3,background="red")),
